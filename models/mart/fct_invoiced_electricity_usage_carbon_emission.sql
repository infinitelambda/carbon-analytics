...
LEFT JOIN {{ ref('stg_additional_modelling_resources__daily_usage_factors') }} FA ON FA.LOCATION_TYPE=pfp.LOCATION_TYPE
),
...
SELECT
  ...
  ROUND(CD.KWH_USAGE, 2) as ESTIMATED_KWH_USAGE,
  CD.LOCATION_TYPE AS LOCATION_TYPE,
  CASE
